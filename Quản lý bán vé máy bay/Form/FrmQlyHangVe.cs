...
{
    public partial class FrmQlyHangVe : Form
    {
        #region Properties
        ...
        {
            if (txtMaHangVe.Text.Trim()!=""&& txtTenHangVe.Text.Trim() != "")
            {
                try
                {
                    dtoHangVe = new DTO_HangVe(txtMaHangVe.Text, txtTenHangVe.Text, Convert.ToInt32(txtLePhiHoan.Text), Convert.ToInt32(txtLePhiDoi.Text));
        ...
        private void dtgvHangVe_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtLePhiHoan.Text = row.Cells[2].Value.ToString();
            txtLePhiDoi.Text = row.Cells[3].Value.ToString();
        }
